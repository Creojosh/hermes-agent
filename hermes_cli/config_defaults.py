...
DEFAULT_CONFIG = {
    ...
    # Managed llama.cpp runtime (docs: user-guide/local-models): official binaries or a user-selected
    # llama.cpp directory, one supervised llama-server in router mode.
    "local_runtime": {
