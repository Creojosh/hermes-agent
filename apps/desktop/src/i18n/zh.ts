...
export const zh = defineLocale({
  ...
  settings: {
    ...
    localModels: {
      ...
      unifiedMemory: '统一内存',
      modelsTitle: '模型',
      modelsDirectoryTitle: '模型存储文件夹',
      modelsDirectoryDescription: path => `所有配置文件共享 · ${path}`,
      modelsDirectoryAction: '选择文件夹',
      modelsDirectoryChoose: '选择本地模型的存储位置',
      modelsDirectoryDefault: '使用默认位置',
      modelsDirectorySaved: count => `文件夹已保存 · 检测到 ${count} 个现有模型。`,
      modelsDirectoryFailed: '无法更改模型存储文件夹',
      recommended: '推荐',
      recommendedReason: {
