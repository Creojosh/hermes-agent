...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    localModels: {
      ...
      unifiedMemory: '統一記憶體',
      modelsTitle: '模型',
      modelsDirectoryTitle: '模型儲存資料夾',
      modelsDirectoryDescription: path => `所有設定檔共用 · ${path}`,
      modelsDirectoryAction: '選擇資料夾',
      modelsDirectoryChoose: '選擇本機模型的儲存位置',
      modelsDirectoryDefault: '使用預設位置',
      modelsDirectorySaved: count => `資料夾已儲存 · 偵測到 ${count} 個現有模型。`,
      modelsDirectoryFailed: '無法變更模型儲存資料夾',
      recommended: '推薦',
      recommendedReason: {
